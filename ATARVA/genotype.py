...
def genotype_parser(subparsers):
    ...
    opt.add_argument('--instability', action='store_true', help='if the input alignment data is RNA-seq [default: False]')
...
def concat_thread_outputs(base_path: str, n_threads: int,
                            debug: bool = False, instability: bool = False) -> None:
    """
    ...
    :param instability: whether to also concatenate instability info
    """
    ...
    # --- instability info concatenation ---
    if instability:
